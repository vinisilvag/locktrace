String handleFirebaseError(dynamic err) {
  return firebaseErrorCodeToMessage(err.code);
}

String firebaseErrorCodeToMessage(String errorCode) {
  ...
  switch (errorCode) {
    ...
    case 'aborted':
      return "A operação foi abortada, possivelmente por um conflito de concorrência.";
    case 'already-exists':
      return "O recurso já existe.";
    case 'cancelled':
      return "A operação foi cancelada.";
    case 'data-loss':
      return "Houve perda ou corrupção de dados.";
    case 'deadline-exceeded':
      return "O tempo limite da operação foi excedido.";
    case 'failed-precondition':
      return "A operação não pôde ser executada no estado atual do sistema.";
    case 'internal':
    ...
    case 'out-of-range':
      return "A operação excedeu os limites permitidos.";
    case 'permission-denied':
      return "Você não tem permissão para realizar esta operação.";
    case 'resource-exhausted':
      return "Os recursos foram esgotados. Tente novamente mais tarde.";
